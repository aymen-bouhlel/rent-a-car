...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Command\\CleanCarCommand' => function (): \App\Command\CleanCarCommand {
    return ($this->privates['App\Command\CleanCarCommand'] ?? $this->load('getCleanCarCommandService.php'));
