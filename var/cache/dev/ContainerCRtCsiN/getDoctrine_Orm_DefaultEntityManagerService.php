...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CarRepository' => function () {
    ...
    return ($this->privates['App\Repository\CityRepository'] ?? $this->load('getCityRepositoryService.php'));
...
}, 'App\\Repository\\KeywordRepository' => function () {
    return ($this->privates['App\Repository\KeywordRepository'] ?? $this->load('getKeywordRepositoryService.php'));
}, 'App\\Repository\\TokenRepository' => function () {
    return ($this->privates['App\Repository\TokenRepository'] ?? $this->load('getTokenRepositoryService.php'));
