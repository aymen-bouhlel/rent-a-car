...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CarType' => function () {
    return ($this->privates['App\Form\CarType'] ?? $this->privates['App\Form\CarType'] = new \App\Form\CarType());
...
}, 'App\\Form\\KeywordType' => function () {
    return ($this->privates['App\Form\KeywordType'] ?? $this->privates['App\Form\KeywordType'] = new \App\Form\KeywordType());
...
}, 'App\\Form\\SearchCarType' => function () {
    return ($this->privates['App\Form\SearchCarType'] ?? $this->privates['App\Form\SearchCarType'] = new \App\Form\SearchCarType());
