...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'\\src\\EventSubscriber\\MaintenanceSubscriber.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('jQV67v8phA', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vhu5w6RsDT', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.response', array(0 => function () {
            return ($this->privates['App\EventSubscriber\MaintenanceSubscriber'] ?? $this->getMaintenanceSubscriberService());
        }, 1 => 'methodCalledOnKernelResponse'), 255);
        $instance->addListener('kernel.response', array(0 => function () {
    ...
    /**
     * Gets the private 'App\EventSubscriber\MaintenanceSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\MaintenanceSubscriber
     */
    protected function getMaintenanceSubscriberService()
    {
        return $this->privates['App\EventSubscriber\MaintenanceSubscriber'] = new \App\EventSubscriber\MaintenanceSubscriber(($this->services['twig'] ?? $this->getTwigService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wBySPoQrWC', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9RPm6bJbn7', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iZEWy+2PhP', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['App\Security\Voter\CarVoter'] ?? $this->privates['App\Security\Voter\CarVoter'] = new \App\Security\Voter\CarVoter());
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'NelmioAliceBundle' => array(
                    'path' => ($this->targetDirs[3].'\\vendor\\nelmio\\alice\\src\\Bridge\\Symfony'),
                    'namespace' => 'Nelmio\\Alice\\Bridge\\Symfony',
                ),
                'FidryAliceDataFixturesBundle' => array(
                    'path' => ($this->targetDirs[3].'\\vendor\\theofidry\\alice-data-fixtures\\src\\Bridge\\Symfony'),
