...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'enable', '' . "\0" . 'App\\Entity\\User' . "\0" . 'cars'];
        }
    ...
    public function addCars($car): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCars', [$car]);
